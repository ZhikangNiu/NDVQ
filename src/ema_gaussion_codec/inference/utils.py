...
if __name__ == "__main__":
    collect_audio_durations("/home/v-zhikangniu/encodec-pytorch/datasets/ls960.csv",output_path='./ls_durations.csv')
    plot_audio_durations("./ls_durations.csv", [0.3,0.5,0.8], output_filename='ls960_audio_durations.png')